      ...
      <nav className="fixed top-0 w-full z-20 shadow-lg lg:shadow-none bg-white">
        <div className="m-4 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-3">
          <div className="hidden lg:block col-span-1 flex text-gray-600 mt-1">
            ...
            <span
              className="hover:bg-gray-200 px-4 py-3 rounded-lg font-light tracking-widest hover:text-gray-800 cursor-pointer"
              onClick={(e) => window.location.href = "http://www.google.com"}
            >
              Wedding registery
            </span>
            <span
          ...
          <div
            ...
            className="hidden lg:block flex items-start px- col-span-1 text-center text-gray-800 font-bold tracking-widest uppercase text-2xl cursor-pointer"
          >
            <img src={logo}  alt="logo" width="50px" className="absolute mx-0"/>
            ShopEase
          </div>
        ...
        >
          <div className="col-span-1 flex flex-col text-gray-600">
            ...
            <span
              className="font-medium text-lg tracking-widest hover:text-gray-800 hover:bg-gray-200 px-3 py-2 rounded-lg cursor-pointer"
              onClick={(e) => window.location.href = "htttp://www.google.com"}
            >
              Wedding registery
            </span>
            <span
